...
<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
    ...
    <head>
        ...
        <script type="text/javascript" src="js/cambiaDeEstadoConsolidacionConzzartrans.js"></script>
        <script type="text/javascript" src="js/verModalConsolidacionConzzartrans.js"></script>
      
        <script type="text/javascript" src="js/tablaConsolidacionConzzartrans.js"></script>
      ...
      <div class="modal-body">
        <form id="id_form_consolidacion" action="nose aun" class="form-horizontal" method="post">
          <div class="form-frame">
            ...
            <div class="form-group">
              <div class="row">
                <label for="descripcion" class="col-sm-4 control-label">Material</label>
              ...
              <div class="row">
                ...
                <div class="row">
                  <label for="descripcion" class="col-sm-6 control-label">material acumulado</label>
                </div>
                <div class="col-sm-12">
                   <textarea id="act_1_acumulador" name="acumulador" class="form-control taller-textarea" placeholder="materiales acumulados"></textarea>
              </div>
...
<!------------/modal consolidacion------------------------------------>
      ...
      //::::::::::::::::modal consolidacion ::::::::::::::::::::::::::::::::::::
                    ...
                    function muestraCliente(id) {
                        ...
                        $.getJSON("consultaListaGeneral", { "filtro": var_cliente }, function (data) {
                        	     $.each(data, function (index, item) {
                        	    	  var tipoTransporteTexto;
                        	          switch (item.tipoTransporte) {
                        	              case "0":
                        	              ...
                        	              case "2":
                        	                  ...
                        	                  break;
                        	              default:
                        	                  tipoTransporteTexto = "Desconocido"; // O algún texto por defecto
                        	                  break;
                        	          }
                                $('#id_table_cliente1').append('<tr><td>' + item.ubigeoorigen.almacenDepartamento + '</td><td>' + item.ubigeodestino.almacenDepartamento + '</td><td>' + item.precioServicio + ' Bs</td><td>' + tipoTransporteTexto + '</td><td>' + item.acumulador + '</td></tr>');
                            });
                        });
                    }
